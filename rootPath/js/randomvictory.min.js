...
!function e(t,n,r){function i(o,c){if(!n[o]){if(!t[o]){var a="function"==typeof require&&require;if(!c&&a)return a(o,!0);if(s)return s(o,!0);var l=new Error("Cannot find module '"+o+"'");throw l.code="MODULE_NOT_FOUND",l}var u=n[o]={exports:{}};t[o][0].call(u.exports,function(e){var n=t[o][1][e];return i(n||e)},u,u.exports,e,t,n,r)}return n[o].exports}for(var s="function"==typeof require&&require,o=0;o<r.length;o++)i(r[o]);return i}({1:[function(e,t,n){"use strict";var r=e("fs"),i=e("./utils"),s=!1,o=e("../package.json").version,c="%",a="locals",l=["cache","filename","delimiter","scope","context","debug","compileDebug","client","_with","rmWhitespace","strict","localsName"],u=/;\s*$/,p=/^\uFEFF/;function h(e,t){var i,s=e.filename,o=arguments.length>1;if(e.cache){if(!s)throw new Error("cache option requires a filename");if(i=n.cache.get(s))return i;o||(t=r.readFileSync(s).toString().replace(p,""))}else if(!o){if(!s)throw new Error("Internal EJS error: no file name or template provided");t=r.readFileSync(s).toString().replace(p,"")}return i=n.compile(t,e),e.cache&&n.cache.set(s,i),i}function f(e,t,n,r){var i=t.split("\n"),s=Math.max(r-3,0),o=Math.min(i.length,r+3),c=i.slice(s,o).map(function(e,t){var n=t+s+1;return(n==r?" >> ":"    ")+n+"| "+e}).join("\n");throw e.path=n,e.message=(n||"ejs")+":"+r+"\n"+c+"\n\n"+e.message,e}function m(e,t){l.forEach(function(n){void 0!==e[n]&&(t[n]=e[n])})}function d(e,t){t=t||{};var r={};this.templateText=e,this.mode=null,this.truncate=!1,this.currentLine=1,this.source="",this.dependencies=[],r.client=t.client||!1,r.escapeFunction=t.escape||i.escapeXML,r.compileDebug=!1!==t.compileDebug,r.debug=!!t.debug,r.filename=t.filename,r.delimiter=t.delimiter||n.delimiter||c,r.strict=t.strict||!1,r.context=t.context,r.cache=t.cache||!1,r.rmWhitespace=t.rmWhitespace,r.localsName=t.localsName||n.localsName||a,r.strict?r._with=!1:r._with=void 0===t._with||t._with,this.opts=r,this.regex=this.createRegex()}n.cache=i.cache,n.localsName=a,n.resolveInclude=function(t,n){var r=e("path"),i=r.dirname,s=r.extname,o=(0,r.resolve)(i(n),t);return s(t)||(o+=".ejs"),o},n.compile=function(e,t){return t&&t.scope&&(s||(console.warn("`scope` option is deprecated and will be removed in EJS 3"),s=!0),t.context||(t.context=t.scope),delete t.scope),new d(e,t).compile()},n.render=function(e,t,n){return t=t||{},n=n||{},2==arguments.length&&m(t,n),h(n,e)(t)},n.renderFile=function(){var e,t=Array.prototype.slice.call(arguments),n=t.shift(),r=t.pop(),s=t.shift()||{},o=t.pop()||{};o=i.shallowCopy({},o),3==arguments.length&&(s.settings&&s.settings["view options"]?m(s.settings["view options"],o):m(s,o)),o.filename=n;try{e=h(o)(s)}catch(e){return r(e)}return r(null,e)},n.clearCache=function(){n.cache.reset()},d.modes={EVAL:"eval",ESCAPED:"escaped",RAW:"raw",COMMENT:"comment",LITERAL:"literal"},d.prototype={createRegex:function(){var e="(<%%|<%=|<%-|<%_|<%#|<%|%>|-%>|_%>)",t=i.escapeRegExpChars(this.opts.delimiter);return e=e.replace(/%/g,t),new RegExp(e)},compile:function(){var e,t,r=this.opts,s="",o="",c=r.escapeFunction;r.rmWhitespace&&(this.templateText=this.templateText.replace(/\r/g,"").replace(/^\s+|\s+$/gm,"")),this.templateText=this.templateText.replace(/[ \t]*<%_/gm,"<%_").replace(/_%>[ \t]*/gm,"_%>"),this.source||(this.generateSource(),s+="  var __output = [], __append = __output.push.bind(__output);\n",!1!==r._with&&(s+="  with ("+r.localsName+" || {}) {\n",o+="  }\n"),o+='  return __output.join("");\n',this.source=s+this.source+o),e=r.compileDebug?"var __line = 1\n  , __lines = "+JSON.stringify(this.templateText)+"\n  , __filename = "+(r.filename?JSON.stringify(r.filename):"undefined")+";\ntry {\n"+this.source+"} catch (e) {\n  rethrow(e, __lines, __filename, __line);\n}\n":this.source,r.debug&&console.log(e),r.client&&(e="escape = escape || "+c.toString()+";\n"+e,r.compileDebug&&(e="rethrow = rethrow || "+f.toString()+";\n"+e)),r.strict&&(e='"use strict";\n'+e);try{t=new Function(r.localsName+", escape, include, rethrow",e)}catch(e){throw e instanceof SyntaxError&&(r.filename&&(e.message+=" in "+r.filename),e.message+=" while compiling ejs"),e}if(r.client)return t.dependencies=this.dependencies,t;var a=function(e){return t.apply(r.context,[e||{},c,function(t,s){var o=i.shallowCopy({},e);return s&&(o=i.shallowCopy(o,s)),function(e,t){var r=i.shallowCopy({},t);if(!r.filename)throw new Error("`include` requires the 'filename' option.");return r.filename=n.resolveInclude(e,r.filename),h(r)}(t,r)(o)},f])};return a.dependencies=this.dependencies,a},generateSource:function(){var e=this,t=this.parseTemplateText(),s=this.opts.delimiter;t&&t.length&&(this.opts.compileDebug&&this.opts.filename&&(this.source="    ; __lines = "+JSON.stringify(this.templateText)+"\n",this.source+='    ; __filename = "'+this.opts.filename.replace(/\\/g,"/")+'"\n'),t.forEach(function(o,c){var a,l,u,h,f;if(0===o.indexOf("<"+s)&&0!==o.indexOf("<"+s+s)&&(l=t[c+2])!=s+">"&&l!="-"+s+">"&&l!="_"+s+">")throw new Error('Could not find matching close tag for "'+o+'".');if((u=o.match(/^\s*include\s+(\S+)/))&&(a=t[c-1])&&(a=="<"+s||a=="<"+s+"-"||a=="<"+s+"_"))return h=i.shallowCopy({},e.opts),f="    ; (function(){\n"+(f=function(e,t){var s,o,c=i.shallowCopy({},t);if(!c.filename)throw new Error("`include` requires the 'filename' option.");s=n.resolveInclude(e,c.filename),o=r.readFileSync(s).toString().replace(p,""),c.filename=s;var a=new d(o,c);return a.generateSource(),a.source}(u[1],h))+"    ; })()\n",e.source+=f,void e.dependencies.push(n.resolveInclude(u[1],h.filename));e.scanLine(o)}))},parseTemplateText:function(){for(var e,t=this.templateText,n=this.regex,r=n.exec(t),i=[];r;)e=r.index,n.lastIndex,0!==e&&(i.push(t.substring(0,e)),t=t.slice(e)),i.push(r[0]),t=t.slice(r[0].length),r=n.exec(t);return t&&i.push(t),i},scanLine:function(e){var t,n=this,r=this.opts.delimiter;function i(){n.truncate?(e=e.replace(/^(?:\r\n|\r|\n)/,""),n.truncate=!1):n.opts.rmWhitespace&&(e=e.replace(/^\n/,"")),e&&(e=(e=(e=(e=e.replace(/\\/g,"\\\\")).replace(/\n/g,"\\n")).replace(/\r/g,"\\r")).replace(/"/g,'\\"'),n.source+='    ; __append("'+e+'")\n')}switch(t=e.split("\n").length-1,e){case"<"+r:case"<"+r+"_":this.mode=d.modes.EVAL;break;case"<"+r+"=":this.mode=d.modes.ESCAPED;break;case"<"+r+"-":this.mode=d.modes.RAW;break;case"<"+r+"#":this.mode=d.modes.COMMENT;break;case"<"+r+r:this.mode=d.modes.LITERAL,this.source+='    ; __append("'+e.replace("<"+r+r,"<"+r)+'")\n';break;case r+">":case"-"+r+">":case"_"+r+">":this.mode==d.modes.LITERAL&&i(),this.mode=null,this.truncate=0===e.indexOf("-")||0===e.indexOf("_");break;default:if(this.mode){switch(this.mode){case d.modes.EVAL:case d.modes.ESCAPED:case d.modes.RAW:e.lastIndexOf("//")>e.lastIndexOf("\n")&&(e+="\n")}switch(this.mode){case d.modes.EVAL:this.source+="    ; "+e+"\n";break;case d.modes.ESCAPED:this.source+="    ; __append(escape("+e.replace(u,"").trim()+"))\n";break;case d.modes.RAW:this.source+="    ; __append("+e.replace(u,"").trim()+")\n";break;case d.modes.COMMENT:break;case d.modes.LITERAL:i()}}else i()}n.opts.compileDebug&&t&&(this.currentLine+=t,this.source+="    ; __line = "+this.currentLine+"\n")}},n.escapeXML=i.escapeXML,n.__express=n.renderFile,e.extensions&&(e.extensions[".ejs"]=function(e,t){var i={filename:t=t||e.filename,client:!0},s=r.readFileSync(t).toString(),o=n.compile(s,i);e._compile("module.exports = "+o.toString()+";",t)}),n.VERSION=o,"undefined"!=typeof window&&(window.ejs=n)},{"../package.json":6,"./utils":2,fs:3,path:4}],2:[function(e,t,n){"use strict";var r=/[|\\{}()[\]^$+*?.]/g;n.escapeRegExpChars=function(e){return e?String(e).replace(r,"\\$&"):""};var i={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&#34;","'":"&#39;"},s=/[&<>\'"]/g;function o(e){return i[e]||e}n.escapeXML=function(e){return null==e?"":String(e).replace(s,o)},n.escapeXML.toString=function(){return Function.prototype.toString.call(this)+';\nvar _ENCODE_HTML_RULES = {\n      "&": "&amp;"\n    , "<": "&lt;"\n    , ">": "&gt;"\n    , \'"\': "&#34;"\n    , "\'": "&#39;"\n    }\n  , _MATCH_HTML = /[&<>\'"]/g;\nfunction encode_char(c) {\n  return _ENCODE_HTML_RULES[c] || c;\n};\n'},n.shallowCopy=function(e,t){for(var n in t=t||{})e[n]=t[n];return e},n.cache={_data:{},set:function(e,t){this._data[e]=t},get:function(e){return this._data[e]},reset:function(){this._data={}}}},{}],3:[function(e,t,n){},{}],4:[function(e,t,n){(function(e){function t(e,t){for(var n=0,r=e.length-1;r>=0;r--){var i=e[r];"."===i?e.splice(r,1):".."===i?(e.splice(r,1),n++):n&&(e.splice(r,1),n--)}if(t)for(;n--;n)e.unshift("..");return e}var r=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/,i=function(e){return r.exec(e).slice(1)};function s(e,t){if(e.filter)return e.filter(t);for(var n=[],r=0;r<e.length;r++)t(e[r],r,e)&&n.push(e[r]);return n}n.resolve=function(){for(var n="",r=!1,i=arguments.length-1;i>=-1&&!r;i--){var o=i>=0?arguments[i]:e.cwd();if("string"!=typeof o)throw new TypeError("Arguments to path.resolve must be strings");o&&(n=o+"/"+n,r="/"===o.charAt(0))}return(r?"/":"")+(n=t(s(n.split("/"),function(e){return!!e}),!r).join("/"))||"."},n.normalize=function(e){var r=n.isAbsolute(e),i="/"===o(e,-1);return(e=t(s(e.split("/"),function(e){return!!e}),!r).join("/"))||r||(e="."),e&&i&&(e+="/"),(r?"/":"")+e},n.isAbsolute=function(e){return"/"===e.charAt(0)},n.join=function(){var e=Array.prototype.slice.call(arguments,0);return n.normalize(s(e,function(e,t){if("string"!=typeof e)throw new TypeError("Arguments to path.join must be strings");return e}).join("/"))},n.relative=function(e,t){function r(e){for(var t=0;t<e.length&&""===e[t];t++);for(var n=e.length-1;n>=0&&""===e[n];n--);return t>n?[]:e.slice(t,n-t+1)}e=n.resolve(e).substr(1),t=n.resolve(t).substr(1);for(var i=r(e.split("/")),s=r(t.split("/")),o=Math.min(i.length,s.length),c=o,a=0;a<o;a++)if(i[a]!==s[a]){c=a;break}var l=[];for(a=c;a<i.length;a++)l.push("..");return(l=l.concat(s.slice(c))).join("/")},n.sep="/",n.delimiter=":",n.dirname=function(e){var t=i(e),n=t[0],r=t[1];return n||r?(r&&(r=r.substr(0,r.length-1)),n+r):"."},n.basename=function(e,t){var n=i(e)[2];return t&&n.substr(-1*t.length)===t&&(n=n.substr(0,n.length-t.length)),n},n.extname=function(e){return i(e)[3]};var o="b"==="ab".substr(-1)?function(e,t,n){return e.substr(t,n)}:function(e,t,n){return t<0&&(t=e.length+t),e.substr(t,n)}}).call(this,e("_process"))},{_process:5}],5:[function(e,t,n){var r=t.exports={},i=[],s=!1;function o(){if(!s){var e;s=!0;for(var t=i.length;t;){e=i,i=[];for(var n=-1;++n<t;)e[n]();t=i.length}s=!1}}function c(){}r.nextTick=function(e){i.push(e),s||setTimeout(o,0)},r.title="browser",r.browser=!0,r.env={},r.argv=[],r.version="",r.versions={},r.on=c,r.addListener=c,r.once=c,r.off=c,r.removeListener=c,r.removeAllListeners=c,r.emit=c,r.binding=function(e){throw new Error("process.binding is not supported")},r.cwd=function(){return"/"},r.chdir=function(e){throw new Error("process.chdir is not supported")},r.umask=function(){return 0}},{}],6:[function(e,t,n){t.exports={name:"ejs",description:"Embedded JavaScript templates",keywords:["template","engine","ejs"],version:"2.4.1",author:"Matthew Eernisse <mde@fleegix.org> (http://fleegix.org)",contributors:["Timothy Gu <timothygu99@gmail.com> (https://timothygu.github.io)"],license:"Apache-2.0",main:"./lib/ejs.js",repository:{type:"git",url:"git://github.com/mde/ejs.git"},bugs:"https://github.com/mde/ejs/issues",homepage:"https://github.com/mde/ejs",dependencies:{},devDependencies:{browserify:"^8.0.3",istanbul:"~0.3.5",jake:"^8.0.0",jsdoc:"^3.3.0-beta1","lru-cache":"^2.5.0",mocha:"^2.1.0",rimraf:"^2.2.8","uglify-js":"^2.4.16"},engines:{node:">=0.10.0"},scripts:{test:"mocha",sample:"npm install express && node sample/index.js",coverage:"istanbul cover node_modules/mocha/bin/_mocha",doc:"rimraf out && jsdoc -c jsdoc.json lib/* docs/jsdoc/*",devdoc:"rimraf out && jsdoc -p -c jsdoc.json lib/* docs/jsdoc/*"}}},{}]},{},[1]);
!function(e){const a=360,t={ui:{compileTemplate:e=>ejs.compile($("#"+e).html()),wallpaper(e,a){let t;t=void 0===a?`images/${e}`:`games/${e.game.guid}/${e.game.song[a].wallpaper}`,$("html").css({"background-image":`url(${t})`})},teams:[{ guid: '000', name: 'Flower' },
{ guid: '001', name: 'Kooper' },{ guid: '002', name: 'Spyhunter' },{ guid: '003', name: 'Doom (night vision)' },{ guid: '004', name: 'Knight' },{ guid: '005', name: 'Mario Axe' },{ guid: '006', name: 'Castlevania' },{ guid: '007', name: 'Tetris' },{ guid: '008', name: 'Mario Coin' },{ guid: '009', name: 'Comix Zone' }],loadData:async e=>(async e=>{return(await fetch(e)).json()})(e),shuffle(e){let a,t,o=e.length;for(;0!==o;)t=Math.floor(Math.random()*o),a=e[o-=1],e[o]=e[t],e[t]=a;return e}}},o=$("#main"),n={Leaderboard:t.ui.compileTemplate("Leaderboard"),GameSelect:t.ui.compileTemplate("GameSelect"),PlayRound:t.ui.compileTemplate("PlayRound")};let l;t.createNewPanel=async()=>{const e=await t.ui.loadData("games/index.json");return{teams:t.ui.shuffle(t.ui.teams),unplayedGames:e.games,playedCount:0}},t.loadPanel=async()=>{let a=e.localStorage.getItem("GuessTheGame");if(a)return JSON.parse(a);{let e=await t.createNewPanel();return t.savePanel(e),e}},t.savePanel=a=>{e.localStorage.setItem("GuessTheGame",JSON.stringify(a))},t.showLeaderboard=async e=>{t.ui.wallpaper("titlescreen.gif"),e.teams=e.teams.sort((e,a)=>e.score&&a.score?a.score-e.score:e.score?-1:a.score?1:-1),o.html(n.Leaderboard(e)),document.onkeypress=async a=>{if(a.charCode>=48&&a.charCode<=57){48===a.charCode?e.currentTeamIndex=9:e.currentTeamIndex=a.charCode-49,e.unplayedGames=t.ui.shuffle(e.unplayedGames);let o=e.unplayedGames.slice(0,3);e.games=[];for(let a=0;a<o.length;a++)e.games[a]=await t.ui.loadData(`games/${o[a]}/index.json`);t.offerChoices(e)}}},t.offerChoices=e=>{o.html(n.GameSelect(e)),clippy.load({name:"Clippy",path:"images/agents/"},e=>{(l=e).show(),l.speak("Welcome to your doom!")}),document.onkeypress=a=>{if(a.charCode>=49&&a.charCode<=51){const o=a.charCode-49,n=$(`a[data-choice=${o}]`);if(1===n.length){let a=n.attr("href").split("#")[1];e.unplayedGames=e.unplayedGames.filter(e=>e!==a),e.game=e.games[o],t.playRound(e)}}}},t.playRound=e=>{t.savePanel(e),o.html(n.PlayRound(e));const s=$("#Buttons"),r=$("#Clock"),i=new Date;let m,c,g,d=0;function h(a){g=a,$("[data-track].jp-playing-track").removeClass("jp-playing-track"),$("[data-track="+g+"]").addClass("jp-playing-track"),e.game.song[a].show?(t.ui.wallpaper(e,a),s.hide()):($("html").removeAttr("style"),s.show()),console.log(e.game.song[g].name),$("#jp_container_1").fadeIn(),c.jPlayer("setMedia",{mp3:`games/${e.game.guid}/${e.game.song[g].song}`}),c.jPlayer("play")}function u(a){let o=0;e.game.song.forEach(e=>{e.show&&(o+=1)}),(a||o===e.game.song.length)&&(e.teams[e.currentTeamIndex].score=d,t.savePanel(e))}s.hide(),c=$("#jplayer_1").jPlayer({ready(){$("#No").on("click",()=>{if(c.jPlayer("play"),$("html").removeClass("guessing"),e.game.song[g].hint.length>0){const a=e.game.song[g].hint.shift();console.log(e.game.song[g].name+":"+a),l.speak(a)}else l.speak("There are no more hints!"),e.game.song[g].show=!0,t.ui.wallpaper(e,g),$("[data-track="+g+"]").html(e.game.song[g].name),s.hide(),u()}),$("#Yes").on("click",()=>{if(!e.game.song[g].show){let a=e.game.song[g].hint.length+1;c.jPlayer("play"),$("html").removeClass("guessing"),d+=a,$("#Score").html(d),l.speak("+"+a+" points!"),e.game.song[g].show=!0,t.ui.wallpaper(e,g),$("[data-track="+g+"]").html(e.game.song[g].name),s.hide(),u()}}),$("li[data-track]").on("click",e=>{h($(e.currentTarget).data("track"))}),m=setInterval(()=>{let e=function(e,t){const o=a-(t.getTime()-e.getTime())/1e3;if(o>0){const e=Math.floor(o/60<<0),a=Math.floor(o%60);return e+":"+(a<10?"0"+a:a)}return"0:00"}(i,new Date);r.html(e),"0:00"===e&&(clearInterval(m),u(!0))},500),$("li[data-track=0]").trigger("click"),l.speak(e.game.hint),console.log(e.game.hint)},swfPath:"js",supplied:"mp3"}).on($.jPlayer.event.ended,()=>{h(g)}),document.onkeypress=a=>{let t={110(){$("#No").trigger("click")},121(){$("#Yes").trigger("click")},103(){e.game.song[g].show||(c.jPlayer("pause"),$("html").addClass("guessing"))}};a.charCode>=48&&a.charCode<=57?48===a.charCode?$("[data-track=9]").trigger("click"):$("[data-track="+(a.charCode-49)+"]").trigger("click"):t.hasOwnProperty(a.charCode)&&t[a.charCode]()}},t.start=async()=>{let e=await t.loadPanel();t.showLeaderboard(e)},e.RandomVictory=t}(window);
