...
!function(e){const a={ui:{compileTemplate:e=>ejs.compile($("#"+e).html()),wallpaper(e,a){let t;t=a?`games/${e.game.guid}/${e.game.song[a].wallpaper}`:`images/${e}`,$("html").css({"background-image":`url(${t})`})},teams:[{guid:"000",name:"Mortal Kombat"},{guid:"001",name:"Tetris"},{guid:"002",name:"Super Metroid"},{guid:"003",name:"Sonic"},{guid:"004",name:"Star Fox"},{guid:"005",name:"Skulls"},{guid:"006",name:"Mega Man"},{guid:"007",name:"Mario"},{guid:"008",name:"Donkey Kong"},{guid:"009",name:"Space Invaders"}],loadData:async e=>(async e=>{return(await fetch(e)).json()})(e),shuffle(e){let a,t,o=e.length;for(;0!==o;)t=Math.floor(Math.random()*o),a=e[o-=1],e[o]=e[t],e[t]=a;return e}}},t=$("#main"),o={Leaderboard:a.ui.compileTemplate("Leaderboard"),GameSelect:a.ui.compileTemplate("GameSelect"),PlayRound:a.ui.compileTemplate("PlayRound")};let n;a.createNewPanel=async()=>{const e=await a.ui.loadData("games/index.json");return{teams:a.ui.shuffle(a.ui.teams),unplayedGames:e.games,playedCount:0}},a.loadPanel=async()=>{let t=e.localStorage.getItem("GuessTheGame");if(t)return JSON.parse(t);{let e=await a.createNewPanel();return a.savePanel(e),e}},a.savePanel=a=>{e.localStorage.setItem("GuessTheGame",JSON.stringify(a))},a.showLeaderboard=async e=>{a.ui.wallpaper("titlescreen.gif"),e.teams=e.teams.sort((e,a)=>e.score&&a.score?a.score-e.score:e.score?-1:a.score?1:-1),t.html(o.Leaderboard(e)),document.onkeypress=async t=>{if(t.charCode>=48&&t.charCode<=57){48===t.charCode?e.currentTeamIndex=9:e.currentTeamIndex=t.charCode-49,e.unplayedGames=a.ui.shuffle(e.unplayedGames);let o=e.unplayedGames.slice(0,3);e.games=[];for(let t=0;t<o.length;t++)e.games[t]=await a.ui.loadData(`games/${o[t]}/index.json`);a.offerChoices(e)}}},a.offerChoices=e=>{t.html(o.GameSelect(e)),clippy.load({name:"Clippy",path:"images/agents/"},e=>{(n=e).show(),n.speak("Welcome to your doom!")}),document.onkeypress=t=>{if(t.charCode>=48&&t.charCode<=50){const o=$("a[data-choice="+(t.charCode-48)+"]");1===o.length&&(e.unplayedGames=e.unplayedGames.filter(e=>e!=o.attr("href")),e.game=e.games[t.charCode-49],a.playRound(e))}}},a.playRound=e=>{a.savePanel(e),t.html(o.PlayRound(e));const l=$("#Buttons"),s=$("#Clock"),r=new Date;let i,m,c=0;function g(t){m=t,$("[data-track].jp-playing-track").removeClass("jp-playing-track"),$("[data-track="+m+"]").addClass("jp-playing-track"),e.game.song[t].show?(a.ui.wallpaper(e,t),l.hide()):($("html").removeAttr("style"),l.show()),console.log(e.game.song[m].name),$("#jp_container_1").fadeIn(),i.jPlayer("setMedia",{mp3:`games/${e.game.guid}/${e.game.song[m].song}`}),i.jPlayer("play")}l.hide(),i=$("#jplayer_1").jPlayer({ready(){$("#No").on("click",()=>{if(i.jPlayer("play"),$("html").removeClass("guessing"),e.game.song[m].hint.length>0){const a=e.game.song[m].hint.shift();console.log(e.game.song[m].name+":"+a),n.speak(a)}else n.speak("There are no more hints!"),e.game.song[m].show=!0,a.ui.wallpaper(e,m),$("[data-track="+m+"]").html(e.game.song[m].name),l.hide()}),$("#Yes").on("click",()=>{let t=e.game.song[m].hint.length+1;i.jPlayer("play"),$("html").removeClass("guessing"),c+=t,$("#Score").html(c),n.speak("+"+t+" points!"),e.game.song[m].show=!0,a.ui.wallpaper(e,m),$("[data-track="+m+"]").html(e.game.song[m].name),l.hide()}),$("li[data-track]").on("click",e=>{g($(e.currentTarget).data("track"))}),setInterval(()=>{s.html(function(e,a){const t=360-(a.getTime()-e.getTime())/1e3;if(t>0){const e=Math.floor(t/60<<0),a=Math.floor(t%60);return e+":"+(a<10?"0"+a:a)}return"0:00"}(r,new Date))},500),$("li[data-track=0]").trigger("click"),n.speak(e.game.hint),console.log(e.game.hint)},swfPath:"js",supplied:"mp3"}).on($.jPlayer.event.ended,()=>{g(m)}),document.onkeypress=a=>{let t={110(){$("#No").trigger("click")},121(){$("#Yes").trigger("click")},103(){e.game.song[m].show||(i.jPlayer("pause"),$("html").addClass("guessing"))}};a.charCode>=48&&a.charCode<=57?48===a.charCode?$("[data-track=9]").trigger("click"):$("[data-track="+(a.charCode-49)+"]").trigger("click"):t.hasOwnProperty(a.charCode)&&t[a.charCode]()}},a.start=async()=>{let e=await a.loadPanel();a.showLeaderboard(e)},e.RandomVictory=a}(window);