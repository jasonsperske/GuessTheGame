...
!function(e){const a=360,t={ui:{compileTemplate:e=>ejs.compile($("#"+e).html()),wallpaper(e,a){let t;t=void 0===a?`images/${e}`:`games/${e.game.guid}/${e.game.song[a].wallpaper}`,$("html").css({"background-image":`url(${t})`})},teams:[{guid:"000",name:"Mortal Kombat"},{guid:"001",name:"Tetris"},{guid:"002",name:"Super Metroid"},{guid:"003",name:"Sonic"},{guid:"004",name:"Star Fox"},{guid:"005",name:"Skulls"},{guid:"006",name:"Mega Man"},{guid:"007",name:"Mario"},{guid:"008",name:"Donkey Kong"},{guid:"009",name:"Space Invaders"}],loadData:async e=>(async e=>{return(await fetch(e)).json()})(e),shuffle(e){let a,t,o=e.length;for(;0!==o;)t=Math.floor(Math.random()*o),a=e[o-=1],e[o]=e[t],e[t]=a;return e}}},o=$("#main"),n={Leaderboard:t.ui.compileTemplate("Leaderboard"),GameSelect:t.ui.compileTemplate("GameSelect"),PlayRound:t.ui.compileTemplate("PlayRound")};let s;t.createNewPanel=async()=>{const e=await t.ui.loadData("games/index.json");return{teams:t.ui.shuffle(t.ui.teams),unplayedGames:e.games,playedCount:0}},t.loadPanel=async()=>{let a=e.localStorage.getItem("GuessTheGame");if(a)return JSON.parse(a);{let e=await t.createNewPanel();return t.savePanel(e),e}},t.savePanel=a=>{e.localStorage.setItem("GuessTheGame",JSON.stringify(a))},t.showLeaderboard=async e=>{t.ui.wallpaper("titlescreen.gif"),e.teams=e.teams.sort((e,a)=>e.score&&a.score?a.score-e.score:e.score?-1:a.score?1:-1),o.html(n.Leaderboard(e)),document.onkeypress=async a=>{if(a.charCode>=48&&a.charCode<=57){48===a.charCode?e.currentTeamIndex=9:e.currentTeamIndex=a.charCode-49,e.unplayedGames=t.ui.shuffle(e.unplayedGames);let o=e.unplayedGames.slice(0,3);e.games=[];for(let a=0;a<o.length;a++)e.games[a]=await t.ui.loadData(`games/${o[a]}/index.json`);t.offerChoices(e)}}},t.offerChoices=e=>{o.html(n.GameSelect(e)),clippy.load({name:"Clippy",path:"images/agents/"},e=>{(s=e).show(),s.speak("Welcome to your doom!")}),document.onkeypress=a=>{if(a.charCode>=48&&a.charCode<=50){const o=$("a[data-choice="+(a.charCode-48)+"]");if(1===o.length){let n=o.attr("href").split("#")[1];e.unplayedGames=e.unplayedGames.filter(e=>e!=n),e.game=e.games[a.charCode-49],t.playRound(e)}}}},t.playRound=e=>{t.savePanel(e),o.html(n.PlayRound(e));const l=$("#Buttons"),r=$("#Clock"),i=new Date;let m,c,g=0;function d(a){c=a,$("[data-track].jp-playing-track").removeClass("jp-playing-track"),$("[data-track="+c+"]").addClass("jp-playing-track"),e.game.song[a].show?(t.ui.wallpaper(e,a),l.hide()):($("html").removeAttr("style"),l.show()),console.log(e.game.song[c].name),$("#jp_container_1").fadeIn(),m.jPlayer("setMedia",{mp3:`games/${e.game.guid}/${e.game.song[c].song}`}),m.jPlayer("play")}function h(){let a=0;e.game.song.forEach(e=>{e.show&&(a+=1)}),a===e.game.song.length&&(e.teams[e.currentTeamIndex].score=g,t.savePanel(e))}l.hide(),m=$("#jplayer_1").jPlayer({ready(){$("#No").on("click",()=>{if(m.jPlayer("play"),$("html").removeClass("guessing"),e.game.song[c].hint.length>0){const a=e.game.song[c].hint.shift();console.log(e.game.song[c].name+":"+a),s.speak(a)}else s.speak("There are no more hints!"),e.game.song[c].show=!0,t.ui.wallpaper(e,c),$("[data-track="+c+"]").html(e.game.song[c].name),l.hide(),h()}),$("#Yes").on("click",()=>{let a=e.game.song[c].hint.length+1;m.jPlayer("play"),$("html").removeClass("guessing"),g+=a,$("#Score").html(g),s.speak("+"+a+" points!"),e.game.song[c].show=!0,t.ui.wallpaper(e,c),$("[data-track="+c+"]").html(e.game.song[c].name),l.hide(),h()}),$("li[data-track]").on("click",e=>{d($(e.currentTarget).data("track"))}),setInterval(()=>{r.html(function(e,t){const o=a-(t.getTime()-e.getTime())/1e3;if(o>0){const e=Math.floor(o/60<<0),a=Math.floor(o%60);return e+":"+(a<10?"0"+a:a)}return"0:00"}(i,new Date))},500),$("li[data-track=0]").trigger("click"),s.speak(e.game.hint),console.log(e.game.hint)},swfPath:"js",supplied:"mp3"}).on($.jPlayer.event.ended,()=>{d(c)}),document.onkeypress=a=>{let t={110(){$("#No").trigger("click")},121(){$("#Yes").trigger("click")},103(){e.game.song[c].show||(m.jPlayer("pause"),$("html").addClass("guessing"))}};a.charCode>=48&&a.charCode<=57?48===a.charCode?$("[data-track=9]").trigger("click"):$("[data-track="+(a.charCode-49)+"]").trigger("click"):t.hasOwnProperty(a.charCode)&&t[a.charCode]()}},t.start=async()=>{let e=await t.loadPanel();t.showLeaderboard(e)},e.RandomVictory=t}(window);