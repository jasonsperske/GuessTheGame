...
!function(e){const a={ui:{compileTemplate:e=>ejs.compile($("#"+e).html()),wallpaper(e,a){let o;o=a?`games/${e.game.guid}/${e.song[track].wallpaper}`:`images/${e}`,$("html").css({"background-image":`url(${o})`})},template:{},teams:[{guid:"000",name:"Mortal Kombat"},{guid:"001",name:"Tetris"},{guid:"002",name:"Super Metroid"},{guid:"003",name:"Sonic"},{guid:"004",name:"Star Fox"},{guid:"005",name:"Skulls"},{guid:"006",name:"Mega Man"},{guid:"007",name:"Mario"},{guid:"008",name:"Donkey Kong"},{guid:"009",name:"Space Invaders"}]}};a.ui.template.leaderBoard=a.ui.compileTemplate("leaderBoard"),a.showLeaderboard=()=>{},a.offerChoices=a=>{clippy.load({name:"Clippy",path:"images/agents/"},e=>{e.show(),e.speak("Welcome to your doom!")}),document.onkeypress=a=>{const o=$("a[data-choice="+(a.charCode-48)+"]");1===o.length&&(e.location.href=o.attr("href"))}},a.playRound=e=>{const o=$("#Buttons"),t=$("#Clock"),n=new Date;let s,l,r,i=0;function g(t){r=t,e.song[t].show?(a.ui.wallpaper(e,t),o.hide()):($("html").removeAttr("style"),o.show()),console.log(e.song[r].name),$("#jp_container_1").fadeIn(),s.jPlayer("setMedia",{mp3:`games/${e.game.guid}/${e.song[t].song}`}),s.jPlayer("play")}o.hide(),clippy.load({name:"Clippy",path:"images/agents/"},c=>{(l=c).show(),s=$("#jplayer_1").jPlayer({ready(){$("#No").on("click",()=>{if(s.jPlayer("play"),$("html").removeClass("guessing"),e.song[r].hint.length>0){const a=e.song[r].hint.shift();console.log(e.song[r].name+":"+a),l.speak(a)}else l.speak("There are no more hints!"),e.song[r].show=!0,a.ui.wallpaper(e,track),$("[data-track="+r+"]").html(e.song[r].name),o.hide()}),$("#Yes").on("click",()=>{let t=e.song[r].hint.length+1;s.jPlayer("play"),$("html").removeClass("guessing"),i+=t,$("#Score").html(i),l.speak("+"+t+" points!"),e.song[r].show=!0,a.ui.wallpaper(e,track),$("[data-track="+r+"]").html(e.song[r].name),o.hide()}),$("[data-track]").on("click",()=>{g($(this).data("track"))}),setInterval(()=>{t.html(function(e,a){const o=360-(a.getTime()-e.getTime())/1e3;if(o>0){const e=Math.floor(o/60<<0),a=Math.floor(o%60);return e+":"+(a<10?"0"+a:a)}return"0:00"}(n,new Date))},500),$("[data-track=0]").trigger("click"),l.speak(e.game.hint),console.log(e.game.hint)},swfPath:"js",supplied:"mp3"}).on($.jPlayer.event.ended,()=>{g(r)})}),document.onkeypress=a=>{let o={110(){$("#No").trigger("click")},121(){$("#Yes").trigger("click")},103(){e.song[r].show||(s.jPlayer("pause"),$("html").addClass("guessing"))}};a.charCode>=48&&a.charCode<=57?e.song[r].show&&(48===a.charCode?$("[data-track=9]").trigger("click"):$("[data-track="+(a.charCode-49)+"]").trigger("click")):o.hasOwnProperty(a.charCode)&&o[a.charCode]()}},e.RandomVictory=a}(window);